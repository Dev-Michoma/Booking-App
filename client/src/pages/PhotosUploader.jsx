    ...
    return(      
        <>
         <div className="flex gap-2">
                      ...
                      <div className="mt-3 left-2 gap-4 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">

                        {
                            addedPhotos.length > 0 && addedPhotos.map(link => (
                                  <div className="h-32 gap-3 flex "  key={link}>
                                   <img className=" rounded-2xl" src={'http://localhost:4000/uploads/' + link} />

                                   <button className=" cursor-pointer absolute text-white rounded-xl bg-opacity-50 bg-black p-1">
