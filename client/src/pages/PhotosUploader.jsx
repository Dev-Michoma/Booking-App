                            ...
                            addedPhotos.length > 0 && addedPhotos.map(link => (
                                  <div className=" gap-3 flex items-center justify-center relative "  key={link}>
                                   <img className=" rounded-2xl" src={'http://localhost:4000/uploads/' + link} />
                                       ...
                                       <button className="absolute bottom-1.5 right-1.5 cursor-pointer text-white rounded-xl bg-opacity-50 bg-black p-1 z-10">
                                   ...
                                   <button className=" cursor-pointer absolute bottom-1.5 left-1.5 text-white  rounded-xl bg-opacity-50 bg-black p-0.5">
                                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
